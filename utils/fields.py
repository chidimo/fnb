...
class AutoSlugField(models.SlugField):
    """
    A slug field that generates its value from another field on same model
    """
    ...
    def __init__(self, *args, **kwargs):
        ...
        set_once = kwargs.pop('set_once', True) # defaults to 'True'
...
class AutoMultipleSlugField(models.SlugField):
    """
    A slug field that generates its value from a list of field names
    """
